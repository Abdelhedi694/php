<?php require_once "affichagePoissons.php" ?>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
          <a class="navbar-brand" href="/boutiqueDePoisson">Poisson 2000</a>
...
<form><button type="submit" name="type" value="douce" class="btn btn-success">eau douce</button></form>
          ...
          <a href="/boutiqueDePoisson" class="btn btn-secondary">tous les poissons</a>
